...
module GamesData
  ...
  #   @games = current_stat_tracker.games
  # end
  ...
  def percentage_home_wins
    ...
    return_percentage(win_counter, @games)
  end
  ...
  def percentage_ties
    ...
    return_percentage(tie_counter, @games)
  end
  ...
  def average_goals_per_game
    ...
    get_average(goal_counter, @games)
  end


  def average_goals(season)

    new_array = @games.select do |row|
      row['season'] == season
    end
    goals = 0
